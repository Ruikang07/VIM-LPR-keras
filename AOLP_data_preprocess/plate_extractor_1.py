...
imgs_dir = "AOLP/AOLP_AC_Image/"
boxes_dir = "AOLP/AOLP_AC_groundtruth_localization/"
plates_dir = "AOLP/AOLP_AC_plates/"
...
imgs_dir = "AOLP/AOLP_LE_Image/"
boxes_dir = "AOLP/AOLP_LE_groundtruth_localization/"
plates_dir = "AOLP/AOLP_LE_plates/"
if not os.path.isdir(plates_dir):
    os.mkdir(plates_dir) 
plate_extractor(imgs_dir, boxes_dir, plates_dir)
...
imgs_dir = "AOLP/AOLP_RP_Image/"
boxes_dir = "AOLP/AOLP_RP_groundtruth_localization/"
plates_dir = "AOLP/AOLP_RP_plates/"
if not os.path.isdir(plates_dir):
    os.mkdir(plates_dir) 
plate_extractor(imgs_dir, boxes_dir, plates_dir)
